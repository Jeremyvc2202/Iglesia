{{--
    Componente: Versículo rotativo
    Uso: colócalo debajo de tu lista de anuncios con
        @include('partials.versiculos')

    Requiere el archivo público: public/data/versiculos.json
    (más de 1000 versículos en español, Reina-Valera 1909, dominio público)
--}}
