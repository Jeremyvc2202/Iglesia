...
<body class="bg-parchment text-ink min-h-screen flex flex-col antialiased selection:bg-wine/10 selection:text-wine">
        ...
        <div class="max-w-4xl mx-auto px-5 sm:px-8">
            <div class="flex items-center justify-between py-4 sm:py-5">
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm font-medium tracking-wide">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-dynamic-bg px-5 py-2.5 rounded-sm text-xs font-semibold uppercase tracking-wider">
                            Acceder
                        </a>
                    @endauth
    ...
    <aside id="mobile-panel" class="md:hidden fixed top-0 right-0 h-full w-[80%] max-w-xs bg-parchment z-50 border-l border-hairline/80 shadow-2xl flex flex-col">
        ...
        <nav class="flex-1 px-6 py-8 space-y-2">
            ...
            @else
                <a href="{{ route('login') }}" class="mobile-link btn btn-dynamic-bg w-full py-3 rounded-sm text-xs font-semibold uppercase tracking-wider mt-6">
                    Acceder
                </a>
            @endauth
        </nav>
