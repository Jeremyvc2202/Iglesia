        ...
        <div class="clay-panel p-6 sm:p-10 rounded-3xl relative">
            ...
            <form action="<?php echo e(route('anuncios.store')); ?>" method="POST" enctype="multipart/form-data" class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 mt-12 pt-8 border-t border-hairline/60">
                    ...
                    <a href="<?php echo e(route('anuncios.admin')); ?>" class="btn btn-ghost clay-shadow w-full sm:w-auto px-6 py-3.5 rounded-lg font-semibold text-sm tracking-widest uppercase text-center">
                        Cancelar
                    </a>
                </div>
            </form>
