...
<?php $__env->startSection('title', 'Editar Culto'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-parchment2/30 backdrop-blur-sm p-6 sm:p-10 rounded-2xl border border-hairline/60 shadow-[0_4px_24px_rgb(36,31,26,0.04)] relative transition-all duration-500 hover:shadow-[0_4px_30px_rgb(122,35,49,0.06)]">
            ...
            <form action="<?php echo e(route('cultos.update', $culto)); ?>" method="POST" enctype="multipart/form-data" class="relative z-10">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <label class="flex items-center gap-2.5 cursor-pointer w-fit p-1">
                        <input type="checkbox" name="activo" value="1"
                               <?php echo e(old('activo', $culto->activo) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <?php if($culto->imagen): ?>
                            <div class="mb-4 w-full max-w-xs">
                                <img src="<?php echo e(asset('storage/' . $culto->imagen)); ?>" alt="Imagen actual del culto"
                        ...
                        <label for="imagen-input"
                            ...
                            <span class="text-sm text-ink/60" id="imagen-label">
                                <?php echo e($culto->imagen ? 'Cambiar imagen' : 'Haz clic para subir una imagen'); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" value="<?php echo e(old('nombre', $culto->nombre)); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="horario" value="<?php echo e(old('horario', $culto->horario)); ?>"
                               class="w-full bg-parchment border border-hairline rounded px-4 py-2.5 text-ink placeholder:text-ink/30 focus:outline-none focus:border-wine focus:shadow-[0_0_0_3px_rgba(122,35,49,0.08)] transition-all duration-200"
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 mt-12 pt-8 border-t border-hairline/60">
                    ...
                    <a href="<?php echo e(route('anuncios.admin')); ?>" class="w-full sm:w-auto px-6 py-3.5 rounded-lg font-semibold text-sm tracking-widest uppercase text-center border border-hairline/80 text-ink/70 hover:bg-parchment hover:text-ink transition-colors">
                        Cancelar
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iglesia\resources\views/cultos/edit.blade.php ENDPATH**/ ?>